...
// Auth: Vicente Iborra
//
// Desc: This file defines the top of the sear namespace.
//=============================================================================

//-----------------------------------------------------------------------------
// Desc: Definition of root object in the sear namespacing scheme.
//-----------------------------------------------------------------------------
var sear = sear || {};
(function(target) {
	...
	target.debugNamespaces = function(label) {
		Session.Output("\n" + label + ":\n");
		for (var prop in sear.namespaces) {
